# Here is a template following the exact formatting and "roadmap" style from your document. You can copy and paste this directly into a Google Doc.  
...
VERSE 1 [Chord] 
(Lyric line starts here) [Chord] 
(Lyric line continues) [DRUMS IN - CUE TYPE]   

CHORUS 1 [Chord] 
(Main hook lyric) [Chord] / [Bass Note] 
(Secondary lyric line) [INSTRUMENT] (OUT)  

 INSTRUMENTAL (BASS IN) 
| [Chord] (Count) 
| [Chord]   

BRIDGE (BUILD on 1/16th) [Chord] 
(Repeat lyric line) [Chord] 
